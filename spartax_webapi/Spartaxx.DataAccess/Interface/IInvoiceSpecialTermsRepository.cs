...
namespace Spartaxx.DataAccess
{
   ...
   public interface IInvoiceSpecialTermsRepository
    {
        ...
        double GetTaxrateForTheGivenTaxyear(PTXboSpecialTermInvoiceTaxrate taxrateDetails, out string errorMessage);//Added by SaravananS. tfs id:63613
